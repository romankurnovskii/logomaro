...
import { Grid, BarChart2, Sparkles, Wand2, Loader2, Hexagon, Activity } from 'lucide-react';
      ...
      >
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="flex items-center gap-4">
            <div className="w-8 h-8 rounded-md bg-gradient-to-br from-[#d4af37] to-[#00ff9d] p-[1px] relative">
              <div className="w-full h-full bg-[#110e0d] rounded-[5px] flex items-center justify-center">
                <Hexagon size={16} className="text-[#e8e3df]" />
              </div>
