/**
 * @file Footer.tsx
 * @description Dumb, static footer component rendering build info and social links.
 *
 * @features
 * - Displays build/version tag (BUILD 3.4.1) in terminal mono style
 * - GitHub and X/Twitter icon links opening in a new tab
 * - No dynamic state, no store access
 *
 * @dependencies lucide-react (icons are inline SVG to keep them self-contained)
 */
export const Footer = () => (
